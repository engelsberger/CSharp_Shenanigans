...
static int ParseInt(string s)
{
    ...
    for (int i = input.Length - 1; i >= 0; i--)
    {
        ...
        else
        {
            ...
            else if (input[i].Equals("hundred") && i + 2 < input.Length && input[i + 2].Equals("thousand")) mod = 3;
            if (input[i].Equals("hundred") && i + 1 < input.Length && input[i + 1].Equals("million")) mod = 5;
            else if (input[i].Equals("hundred") && i + 2 < input.Length && input[i + 2].Equals("million")) mod = 5;
        }
